  ...
  return (
    <div className="about-us-container">
      <div className="about-us">
        ...
        <div className="right">
          <img src={img14} alt="About us" />
        </div>
      </div>

      <div className="about-us-para">
        <div className="img1">
          <img src={img15} alt="Pet care" />
        </div>
        <div className="img2">
          <img src={img15} alt="Pet care" />
        </div>
        <div className="about-us-content">
          <p>
            At PetzzyWeb, we believe that pets are family, and their health,
            ...
            for online consultations and in-person care.
          </p>
          <img src={img15} alt="Pet love" />
        </div>
      </div>
      ...
      <div className="about-us our-mission">
        <div className="left our-mission-left">
          ...
          <p className="our-mission-para">
            We aim to create a seamless experience for pet owners, ensuring that
            everything from adopting a new pet to finding the right products or
            receiving professional medical care is just a click away. We’re
            dedicated to providing a reliable and compassionate service, built on
            trust, transparency, and a deep love for animals.
          </p>
        </div>
        <div className="right our-mission-right">
          <img src={img16} alt="Our mission" />
        </div>
      </div>
      ...
      <div className="about-us-sec3">
        <div className="sec3-left">
          <p>
            Whether you’re welcoming a new pet into your home or ensuring your
            current companion gets the best care, PetzzyWeb is here to support
            every step of your journey.
          </p>
        </div>

        <div className="sec3-img">
          <img src={img17} alt="Pets" />
        </div>
